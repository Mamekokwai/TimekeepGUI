...
runTest("web timeline treats domain like app and keeps page titles as details", () => {
  const items = buildWebTimelineItems([
    makeSegment({
      ...
      normalizedDomain: "github.com",
      title: "Issues · Patina",
      url: "https://github.com/Ceceliaee/patina/issues",
      startTime: 0,
      endTime: 5_000,
    }),
    makeSegment({
      ...
      url: "https://github.com/Ceceliaee/patina/pulls",
      startTime: 7_000,
      endTime: 10_000,
    }),
  ], { startMs: 0, endMs: 20_000 }, 20_000, {}, {}, 5);
  ...
  assert.deepEqual(items[0].titleSampleDetails, [
    {
      title: "Issues · Patina",
      secondaryText: "https://github.com/Ceceliaee/patina/issues",
      startTime: 0,
      endTime: 5_000,
      duration: 5_000,
    },
    {
      title: "Pull requests · Patina",
      secondaryText: "https://github.com/Ceceliaee/patina/pulls",
      startTime: 7_000,
      endTime: 10_000,
      duration: 3_000,
    },
